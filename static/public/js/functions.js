...
(function($) {
    ...
    INSPIRO.elements = {
        ...
        formAjaxProcessing: function() {
            var $ajaxForm = $(
                ".widget-contact-form:not(.custom-js), .ajax-patients:not(.custom-js)"
            );
            ...
            if ($flickr_widget.length > 0) {
                ...
                $flickr_widget.each(function() {
                    ...
                    elem.options = {
                        ...
                        itemTemplate: '<a href="{{image}}" title="{{title}}"><images src="{{image_s}}" alt="{{title}}" /></a>',
                    };
